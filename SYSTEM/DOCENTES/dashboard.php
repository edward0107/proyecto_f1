          ...
          <div class="col-lg-8 d-flex align-items-strech">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Avisos Mes de Septiembre</h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Aviso</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Informador</h6>
                        </th>
                        <th class="border-bottom-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <h6 class="fw-semibold mb-1">Reunion de padres</h6>
                          
                        </td>
                        <td class="border-bottom-0">
                          <p class="mb-0 fw-normal">Prof. Juan Fernando</p>
                        </td>
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-2">
                            <span class="badge bg-primary rounded-3 fw-semibold">Alta</span>
                          </div>
                        </td>
                        <td class="border-bottom-0">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">Tareas por Entregar</h5>
              ...
              <div class="col-lg-12">
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">Pagos por Realizar</h5>
                    <div class="row align-items-center">
                      <div class="col-8">
